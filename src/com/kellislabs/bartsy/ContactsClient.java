...
public class ContactsClient extends Activity {
    ...
    private ContactNameId[] mContactNames;
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            case MESSAGE_DISPLAY_ALL_CONTACTS: 
                mContactNames = (ContactNameId[]) msg.obj;
                /*
    ...
    class BusHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            case JOIN_SESSION: {
                ...
                if (status == Status.OK) {
                	mProxyObj = mBus.getProxyBusObject(SERVICE_NAME, "/addressbook", sessionId.value,
                				                       new Class[] { ContactAddressBookInterface.class });
                   	mAddressBookInterface = mProxyObj.getInterface(ContactAddressBookInterface.class);
            ...
            case GET_CONTACT: {
            	...
            	try {
                    ContactNameId contactNameId = (ContactNameId)msg.obj;
                    Contact reply = mAddressBookInterface.getContact(contactNameId.displayName, contactNameId.userId);
